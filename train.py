...
def main():
    ...
    #     print("training_args.project_name",training_args.project_name)
    #     print("training_args.run_name",training_args.run_name)
    ...
    # print("data_args.dataset_config", data_args.dataset_config)
    with open(data_args.dataset_config,
              'r') as yaml_file:
    ...
    # print("train_collator", train_collator)
