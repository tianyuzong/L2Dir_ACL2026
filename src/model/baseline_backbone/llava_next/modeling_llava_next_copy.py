...
# from .modeling_vic import LlamaForCausalLM
#
...
#
# @dataclass
# class LlavaNextCausalLMOutputWithPast_unnorm(ModelOutput):
#     """
...
#     @replace_return_docstrings(output_type=LlavaNextCausalLMOutputWithPast_unnorm, config_class=_CONFIG_FOR_DOC)
#     def forward(
#         self,
...
#         *args, **kwargs
#     ) -> Union[Tuple, LlavaNextCausalLMOutputWithPast_unnorm]:
#         r"""
#         Args:
...
#
#         return LlavaNextCausalLMOutputWithPast_unnorm(
#             loss=loss,
#             logits=logits,
