...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def forward(
        ...
        for decoder_layer in self.layers:
            ...
            hidden_states_unnorm = layer_outputs[0]
        ...
        hidden_states = self.norm(hidden_states_unnorm)
...
@dataclass
class Qwen2_5_VLCausalLMOutputWithPast_unnoram(ModelOutput):
    """
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        return Qwen2_5_VLCausalLMOutputWithPast_unnoram(
